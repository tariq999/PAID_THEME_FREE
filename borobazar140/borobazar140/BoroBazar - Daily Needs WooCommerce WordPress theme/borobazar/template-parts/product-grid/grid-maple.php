...
<div <?php wc_product_class('borobazar-grid-maple', $product); ?>>
    ...
    <div class="borobazar-product-<?php echo esc_attr($product->get_id()); ?> borobazar-maple-product-card h-full p-[10px] grid grid-cols-[150px,1fr] lg:grid-cols-[180px,1fr] xl:grid-cols-[160px,1fr]  2xl:grid-cols-[180px,1fr] gap-5 border border-[#EAEEF2] rounded bg-white overflow-hidden transition-all hover:shadow-product-hover">

        <div class="borobazar-maple-product-card-thumb relative h-36 lg:h-48 xl:h-40 2xl:h-48 overflow-hidden">
        ...
        <div class="borobazar-maple-product-card-meta flex flex-col py-[18px] pr-[5px]">
            <div class="borobazar-maple-product-card-price text-sm sm:text-base text-main font-semibold mb-0.5 sm:mb-1.5">
                <?php woocommerce_template_loop_price(); ?>
            </div>

            <a href="<?php echo esc_url($link); ?>" class="borobazar-maple-product-card-title block text-sm sm:text-md leading-6 overflow-hidden text-ellipsis no-underline mb-3">
            ...
            <?php if ($isInStock) { ?>
                <?php if ($productType === 'simple') { ?>
                    ...
                    <!-- Counter -->
                    <div class="<?php echo esc_attr($display); ?> justify-between bg-brand rounded-[4px] z-1 mt-auto borobazar-qty-button borobazar-qty-button-<?php echo esc_attr($product->get_id()); ?>">
